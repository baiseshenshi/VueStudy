<script setup>
import { ref } from "vue"
const imgPathArr = ["/images/messi.png","/images/neymar.png"]

const imgPath = ref(imgPathArr[0])

const changeImg = () => {
  if (imgPath.value === imgPathArr[0]) {
    imgPath.value = imgPathArr[1]
  }else {
    imgPath.value = imgPathArr[0]
  }
}
const attrs = {
    id: "box1",
